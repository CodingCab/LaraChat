...
return new class extends Migration
{
    public function up(): void
    {
        $conditions = [
            ...
            [
                'class' => \App\Modules\Automations\src\Conditions\Order\OriginStatusCodeEqualsCondition::class,
                'description' => 'Origin Order Status Code equals',
            ],
            [
                'class' => \App\Modules\Automations\src\Conditions\Order\OriginStatusCodeInCondition::class,
                'description' => 'Origin Order Status Code in',
            ],
            [

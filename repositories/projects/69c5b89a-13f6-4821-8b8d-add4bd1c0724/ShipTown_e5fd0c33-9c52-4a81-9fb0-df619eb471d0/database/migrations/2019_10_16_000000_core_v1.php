...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('supplier', 255)->default('');
            ...
            $table->decimal('volumetric_weight')->storedAs('length * width * height')->comment('length * width * height');
        ...
        Schema::create('orders_products_totals', function (Blueprint $table) {
            ...
            $table->decimal('total_weight', 20, 2)->nullable();
            $table->decimal('total_volumetric_weight', 20, 2)->nullable();
        ...
        Schema::create('modules_api2cart_order_imports', function (Blueprint $table) {
            ...
            $table->bigInteger('api2cart_order_id');
            $table->json('raw_import');
            $table->string('order_status_in_sync')->default(false)->nullable();
            $table->timestamps();
            ...
            $table->index([
                ...
                'api2cart_order_id',
                'when_processed'
            ], 'connection_id_api2cart_order_id_when_processed_index');
        });
        ...
        Schema::create('configurations', function (Blueprint $table) {
            ...
            $table->boolean('ecommerce_connected')->default(0);
        ...
        Schema::create('heartbeats', function (Blueprint $table) {
            ...
            $table->string('auto_heal_job_class')->nullable();
        ...
        Schema::create('data_collection_records', function (Blueprint $table) {
            ...
            $table->decimal('unit_full_price', 10, 2)->nullable();
        ...
        Schema::create('inventory_totals_by_warehouse_tag', function (Blueprint $table) {
            $table->id();
            $table->string('warehouse_tag_name')->nullable();
            $table->string('product_sku')->nullable();
            $table->unsignedBigInteger('product_id')->index();
            $table->unsignedInteger('tag_id');
            $table->boolean('recalc_required')->default(1);
            $table->decimal('quantity', 20)->default(0);
            $table->decimal('quantity_reserved', 20)->default(0);
            $table->decimal('quantity_available', 20)
                ->storedAs('quantity - quantity_reserved')

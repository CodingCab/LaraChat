    ...
    methods: {
        loadProduct(product_id) {
            let params = {
                ...
                'include': 'inventory,tags,prices,aliases,inventory.warehouse,inventoryMovementsStatistics,inventoryTotals,productDescriptions,productPicture,saleTax,assemblyProducts,assemblyProducts.simpleProduct',
            };

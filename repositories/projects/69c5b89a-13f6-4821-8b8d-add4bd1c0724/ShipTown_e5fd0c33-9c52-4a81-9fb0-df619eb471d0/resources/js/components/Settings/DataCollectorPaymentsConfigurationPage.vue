<template>
    <div>
        ...
        <search-and-option-bar :isStickable="true">
            <barcode-input-field :input_id="'payment_type_input'" :placeholder="$t('Search')" ref="barcode" :url_param_name="'search'"
                @refreshRequest="reloadPaymentTypesList" @barcodeScanned="findText" />
        ...
        <template v-if="isLoading === false && paymentTypes !== null && Array.isArray(paymentTypes) && paymentTypes.length === 0">
        ...
        <template v-if="paymentTypes">
            <swiping-card v-for="type in paymentTypes" disable-swipe-right disable-swipe-left :key="type['id']">

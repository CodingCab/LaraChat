<template>
    <div>
        <div class="card card-default">
            ...
            <div class="card-body">
                <p v-if="connections.length === 0" class="flex-fill text-center">
                    <button class="btn btn-primary mt-3" v-b-modal.dpd-poland-create-form-modal>Connect</button>
                </p>
                <table v-if="connections.length > 0" class="table table-borderless table-responsive mb-0">
                    ...
                    <tr v-for="connection in connections" :key="connection['id']">
                        ...
                        <td>
                            <div>{{ connection['collection_address']['first_name'] }}
                                {{ connection['collection_address']['last_name'] }}
                            </div>
                        ...
                        <td>
                            <a @click="handleDelete(connection.id)" class="action-link text-danger">
                                {{ $t('Delete') }}
                            </a>
                        </td>
                    </tr>
        ...
        <!-- The modal -->
        <b-modal ref="createFormModal" id="dpd-poland-create-form-modal" title="New DPD Poland connection"
                 @ok="handleModalOk">

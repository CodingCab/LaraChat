    ...
    <div>
        <div class="card card-default">
            ...
            <div class="card-body">
                <table v-if="has_configuration" class="table table-borderless table-responsive mb-0">
                    ...
                    <tbody>
                        <tr key="1">
                            ...
                            <td>
                                <a class="action-link" v-b-modal.dpd-update-form-modal>{{ $t('Edit') }}</a>
                            </td>
                            <td>
                                <a @click="handleDelete(configuration.id)" class="action-link text-danger">{{ $t('Delete') }}</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <p v-else class="mb-0">
                    {{ $t('You have not created any DPD Ireland Configuration.') }}
                </p>
            </div>
        </div>

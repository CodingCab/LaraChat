        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div ref="loadingContainer2" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $t('Create Automation') }}</h5>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="create-name">{{ $t('Automation Name') }}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="create-priority">{{ $t('Priority') }}</label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label dusk="create-enabled" for="create-enabled">{{ $t('Enabled') }}</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <ValidationProvider vid="event_class" name="event_class" v-slot="{ errors }">
                                            ...
                                            >
                                                <option value="">-</option>
                                                <option v-for="event, index in events" :key="index" :value="event.description">{{ event.description }}</option>
                                            </select>
                                            <div class="invalid-feedback">
                                                {{ errors[0] }}
                                            </div>
                                        ...
                                        <ValidationProvider :vid="`conditions.${index}.condition_value`" :name="`conditions.${index}.condition_value`" v-slot="{ errors }">
                                            <div class="input-group mb-1">
                                                <input v-model="condition.condition_value" :class="{
                                                    ...
                                                    :id="`create-condition-value-${index}`"
                                                />
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" @click="submit" dusk="create-save-button" class="btn btn-primary">{{ $t('Save') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    computed: {
        selectedEvent(){
            return this.events.find(event => {
                if (event.class) {
                    return event.class === this.automation.event_class;
                }
                return event.description === this.automation.event_class;
            });
        }
    },
    ...
    methods: {
        ...
        submit() {
            ...
            this.apiPostAutomations(this.automation)
                .then(({ data }) => {
                    this.$snotify.success(this.$t('Automation created.'));
                    this.closeModal();
                    this.resetForm()

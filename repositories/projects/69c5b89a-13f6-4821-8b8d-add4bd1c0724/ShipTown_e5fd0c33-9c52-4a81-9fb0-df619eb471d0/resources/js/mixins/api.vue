    ...
    methods: {
        ...
        displayApiCallError: function (error) {
            ...
            if (error.response.status >= 400 && error.response.status < 599) {
                this.notifyError(JSON.stringify(this.$t(error.response.data.message)));
                return;
            }

            this.notifyError('API call failed: ' + error.status + ' ' + this.$t(error.response.data.message));
        },
        ...
        apiPutProducts: function (id, data) {
        ...
        apiDeleteProductsAliases: function (id) {
            return axios.delete('/api/products-aliases/' + id);
        },
        ...
        apiPostProductTags: function (data) {
            return axios.post('/api/product/tags', data );
        },

        apiPostChatGptGenerateProductDescriptions: function (data) {
            return axios.post('/api/modules/chatgpt/generate-products-descriptions', data);
        },

        apiPostChatGptTranslateProductDescriptions: function (data) {
            return axios.post('/api/modules/chatgpt/translate-products-descriptions', data);
        },

        apiPostChatGptChat: function (data) {
            return axios.post('/api/modules/chatgpt/chat', data);
        },

        apiPostProductDescriptions: function (data) {
            return axios.post('/api/product/descriptions', data);
        },
        ...
        apiGetInventoryReservations(params) {
            return axios.get('/reports/inventory-reservations', { params: params });
        },

        apiPostInventoryMovements(data) {
        ...
        apiGetCsvImportProducts(params) {
            return axios.get('/api/csv-import/products', { params: params });
        },
        ...
        apiGetOrderAddresses: function (params) {
            return axios.get('/api/order/addresses', { params: params });
        },
        apiUpdateOrderAddress: function (order_address_id, data) {
            return axios.put('/api/order/addresses/' + order_address_id, data);
        },
        apiPostOrderAddress: function (data) {
            return axios.post('/api/order/addresses', data);
        },

        apiPostOrderTags: function (data) {
            return axios.post('/api/order/tags/', data);
        },

        apiGetOrderTags: function (params) {
            return axios.get('/api/order/tags', { params: params });
        },
        ...
        apiPostUserRole: function (data) {
            return axios.post('/api/admin/user/roles', data);
        },

        apiDeleteUserRole: function (id) {
            return axios.delete('/api/admin/user/roles/' + id);
        },
        ...
        apiGetFakturowoConfiguration: function (params) {
            return axios.get('/api/modules/fakturowo/configuration', { params: params });
        },

        apiPostFakturowoConfiguration(data) {
            return axios.post(`/api/modules/fakturowo/configuration`, data);
        },

        apiDeleteFakturowoConfiguration: function (id) {
            return axios.delete(`/api/modules/fakturowo/configuration/${id}`);
        },
        ...
        apiDeleteModuleAutoStatusPickingConfiguration: function (configuration) {
            return axios.delete(`/api/modules/autostatus/picking/configuration/${configuration.id}`);
        },
        ...
        apiStoreMailTemplate: function (data) {
        ...
        apiGetPointOfSaleConfiguration() {
            return axios.get('/api/modules/point-of-sale-configuration')
        },

        apiPostPointOfSaleConfiguration: function (id, params) {
            return axios.put('/api/modules/point-of-sale-configuration/' + id, params)
        },
        ...
        apiPreviewReceipt: function (data) {
            return axios.get('/api/transaction/receipt-preview', { params: data });
        },
        ...
        apiGetDiscounts: function (params) {
            return axios.get('/api/data-collector-discounts', { params: params });
        },

        apiPostDiscount: function (data) {
            return axios.post('/api/data-collector-discounts', data);
        },

        apiDeleteDiscount: function (id) {
            return axios.delete('/api/data-collector-discounts/' + id);
        },
        ...
        apiPostScheduledReport: function (data) {
            return axios.post('/api/modules/scheduled-reports', data);
        },

        apiGetScheduledReport: function (params) {
            return axios.get('/api/modules/scheduled-reports', { params: params });
        },

        apiPutScheduledReport: function (id, data) {
            return axios.put('/api/modules/scheduled-reports/' + id, data);
        },

        apiDeleteScheduledReport: function (id) {
            return axios.delete('/api/modules/scheduled-reports/' + id);
        },

        apiGetSalesTaxes: function (params) {
            return axios.get('/api/modules/sales-taxes', { params: params });
        },
        apiPostSalesTax: function (data) {
            return axios.post('/api/modules/sales-taxes', data);
        },
        apiPutSalesTax: function (data) {
            return axios.put('/api/modules/sales-taxes/' + data.id, data);
        },
        apiDeleteSalesTax: function (id) {
            return axios.delete('/api/modules/sales-taxes/' + id);
        },

        apiGetPermissions: function (params) {
            return axios.get('/api/modules/permissions', { params: params });
        },
        apiUpdatePermissions: function (data) {
            return axios.put('/api/modules/permissions/bulk-update', data);
        },

        apiAssembleProducts: function (data) {
            return axios.post('/api/assemble-products', data);
        },

        apiDisassembleProducts: function (data) {
            return axios.post('/api/disassemble-products', data);
        },

        apiPostAssemblyProductElement: function (data) {
            return axios.post('/api/assembly-product-elements', data);
        },
        apiPutAssemblyProductElement: function (id, data) {
            return axios.put('/api/assembly-product-elements/' + id, data);
        },
        apiDeleteAssemblyProductElement: function (id) {
            return axios.delete('/api/assembly-product-elements/' + id);
        },
    }
}
</script>

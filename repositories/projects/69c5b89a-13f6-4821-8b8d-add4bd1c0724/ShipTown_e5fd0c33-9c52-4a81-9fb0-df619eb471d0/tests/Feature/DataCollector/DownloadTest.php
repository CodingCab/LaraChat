...
class DownloadTest extends TestCase
{
    ...
    public function test_if_works()
    {
        $this
            ...
            ->get('/data-collector/2?warehouse_code=DUB&select=product_sku,product_name,total_transferred_in,total_transferred_out,quantity_requested,quantity_to_scan,quantity_scanned,inventory_quantity,product_price,product_sale_price,product_sale_price_start_date,product_sale_price_end_date,product_cost,last_7_days_sales,last_14_days_sales,last_28_days_sales&filter%5Bdata_collection_id%5D=2&filename=Transfer%20from%20Warehouse.csv')
            ->assertSuccessful();
    }
}

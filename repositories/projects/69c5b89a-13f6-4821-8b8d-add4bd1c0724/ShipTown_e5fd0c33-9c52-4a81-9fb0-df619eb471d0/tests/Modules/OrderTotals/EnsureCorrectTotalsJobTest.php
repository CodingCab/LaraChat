...
class EnsureCorrectTotalsJobTest extends TestCase
{
    ...
    public function test_if_updates_totals(): void
    {
        ...
        ray(Order::query()->get()->toArray());
        ray(OrderProduct::query()->get()->toArray());
        ray(OrderProductTotal::query()->get()->toArray());
        ...
        $this->assertDatabaseHas('orders_products_totals', ['total_products_shipped' => $orderProduct->total_products_shipped]);
    }
}

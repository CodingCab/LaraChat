...
class ClearDatabaseCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Clears the database except migrations table ' .
    'as this is intended only for testing purposes, please use with caution.';
    ...
    public static function resetDatabase(): void
    {
        ...
        App\Modules\Api2cart\src\Models\Api2cartOrderImports::query()->forceDelete();
        ...
        App\Modules\InventoryMovementsDailyStatistics\src\Models\InventoryMovementsDay::query()->forceDelete();
        App\Modules\InventoryMovementsDailyStatistics\src\Models\InventoryMovementsDailyStatistic::query()->forceDelete();
        ...
        App\Modules\ScheduledReport\src\Models\ScheduledReport::query()->truncate();
        App\Modules\SalesTaxes\src\Models\SaleTax::query()->truncate();
        ...
        if (Schema::hasTable('modules_automations_available_conditions')) {
            App\Modules\Automations\src\Models\AvailableCondition::query()->forceDelete();
        }
        if (Schema::hasTable('modules_automations_available_actions')) {
            App\Modules\Automations\src\Models\AvailableAction::query()->forceDelete();
        }
        ...
        App\Modules\AutoStatusRefill\src\Models\Automation::query()->forceDelete();
        ...
        // reinstall default automation actions and conditions
        (require database_path('migrations/2025_07_11_000001_insert_default_automation_lists.php'))->up();
    }
}

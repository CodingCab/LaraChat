...
use App\Modules\Reports\src\Models\NavigationMenuReport;
use Illuminate\Http\Resources\Json\JsonResource;

class NavigationMenuController extends Controller
{
    public function index(NavigationMenuIndexRequest $request): JsonResource
    {
        $report = new NavigationMenuReport();

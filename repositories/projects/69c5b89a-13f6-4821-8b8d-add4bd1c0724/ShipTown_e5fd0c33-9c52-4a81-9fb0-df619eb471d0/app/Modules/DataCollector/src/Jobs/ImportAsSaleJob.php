...
class ImportAsSaleJob extends UniqueJob
{
    ...
    {
        Log::debug('ImportAsSaleJob started', ['data_collection_id' => $this->dataCollection_id]);
        ...
        $dataCollection->records()
            ...
            ->chunkById(10, function ($records) {
                $records->each(function (DataCollectionRecord $record) {
                    DataCollectorService::importAsSale($record);
                });
            });
        ...
        if ($hasMoreRecordsToTransfer) {
            ...
            Log::debug('ImportAsSaleJob finished', ['data_collection_id' => $this->dataCollection_id]);
        }

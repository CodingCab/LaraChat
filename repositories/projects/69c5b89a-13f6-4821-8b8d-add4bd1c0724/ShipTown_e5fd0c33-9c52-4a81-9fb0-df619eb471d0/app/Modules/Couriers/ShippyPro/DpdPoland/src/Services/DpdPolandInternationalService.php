...
class DpdPolandInternationalService extends ShippingServiceAbstract
{
        ...
        try {
            $shippingLabels = ShippyProApi::createShippingLabel($order, [
                'Params' => [
                    ...
                    'TotalValue' => "$order->total_order PLN",
            ...
            throw new ShippingServiceException('DPD Poland (International): ' . $exception->getMessage());
        }
    }
}

...
class InPostPolandLockerStandardSizeAService extends ShippingServiceAbstract
{
    public function ship(int $order_id, ?ShippingService $shippingService = null): Collection
    {
        ...
        try {
            ...
            throw new ShippingServiceException('InPost Poland (Locker Standard - Size A): ' . $exception->getMessage());
        }
    }
}

...
class StocktakeSuggestionReport extends Report
{
    public function __construct(array $attributes = [])
    {
        ...
        $this->addField('points', 'stocktake_suggestions.points', type: 'numeric', hidden: false);
        $this->addField('reason', 'stocktake_suggestions.reason', hidden: false);
        $this->addField('quantity_in_stock', 'inventory.quantity', type: 'numeric', hidden: false);

...
<template>
    <div :class="['flex', message.role === 'user' ? 'justify-end' : 'justify-start']">
        ...
        >
            ...
            <p :class="['mt-1 text-xs', message.role === 'user' ? 'text-green-100' : 'text-gray-500 dark:text-gray-400']">
            ...
            >
                ...
                <div
                    ...
                    class="overflow-x-auto rounded bg-gray-100 p-2 font-mono text-xs dark:bg-gray-800"
                >
